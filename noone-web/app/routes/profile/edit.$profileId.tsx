...
export default function EditProfile() {
  ...
  const [reqCompression, setReqCompression] = useState<string>(profile.requestTransformations[0]);
  const [reqEncryption, setReqEncryption] = useState<string>(profile.requestTransformations[1]);
  const [reqEncoding, setReqEncoding] = useState<string>(profile.requestTransformations[2]);
  const [resCompression, setResCompression] = useState<string>(profile.responseTransformations[0]);
  const [resEncryption, setResEncryption] = useState<string>(profile.responseTransformations[1]);
  const [resEncoding, setResEncoding] = useState<string>(profile.responseTransformations[2]);
