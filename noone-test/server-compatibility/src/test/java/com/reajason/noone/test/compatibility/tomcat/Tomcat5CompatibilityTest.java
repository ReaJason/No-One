...
@Slf4j
@Testcontainers
public class Tomcat5CompatibilityTest {

    @Container
    public static final GenericContainer<?> container = new GenericContainer<>("reajason/tomcat:5-jdk6")
            .withCopyToContainer(WebAppFile.war, "/usr/local/tomcat/webapps/app.war")
