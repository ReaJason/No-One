...
import com.reajason.noone.core.shelltool.NoOneStagelessWebFilter;
...
class NoOneStagelessGeneratorReactorHttpProtocolConfigTest {
    ...
    class GetArgFromRequestTests {
        ...
        class MultipartFormDataTests {
            ...
            void shouldExtractPayloadFromMultipartBody() throws Exception {
                ...
                HttpProtocolConfig config = new HttpProtocolConfig();
                config.setRequestBodyType(HttpRequestBodyType.MULTIPART_FORM_DATA);
                config.setRequestTemplate(template);
        ...
        class JsonTests {
            ...
            void shouldExtractPayloadFromJsonBody() throws Exception {
                ...
                HttpProtocolConfig config = new HttpProtocolConfig();
                config.setRequestBodyType(HttpRequestBodyType.JSON);
                config.setRequestTemplate(template);
        ...
        class XmlTests {
            ...
            void shouldExtractPayloadFromXmlBody() throws Exception {
                ...
                HttpProtocolConfig config = new HttpProtocolConfig();
                config.setRequestBodyType(HttpRequestBodyType.XML);
                config.setRequestTemplate(template);
        ...
        class TextTests {
            ...
            void shouldExtractPayloadFromTextBody() throws Exception {
                ...
                HttpProtocolConfig config = new HttpProtocolConfig();
                config.setRequestBodyType(HttpRequestBodyType.TEXT);
                config.setRequestTemplate(template);
        ...
        class BinaryTests {
            ...
            void shouldExtractPayloadFromBinaryBody() throws Exception {
                ...
                HttpProtocolConfig config = new HttpProtocolConfig();
                config.setRequestBodyType(HttpRequestBodyType.BINARY);
                config.setRequestTemplate(template);
    ...
    class IntegrationTests {
        ...
        void httpProtocolConfig_shouldBeAppliedToReactorWebFilter() throws Exception {
            ...
            http.setRequestBodyType(HttpRequestBodyType.TEXT);
    ...
    private static byte[] generateBytes(HttpProtocolConfig http) {
        ...
        noOneConfig.setShellClass(NoOneStagelessWebFilter.class);
    ...
    private static Class<?> loadGeneratedClass(byte[] bytes) {
        ...
        return new DefiningClassLoader(NoOneStagelessWebFilter.class.getClassLoader()).define();
    }
}
