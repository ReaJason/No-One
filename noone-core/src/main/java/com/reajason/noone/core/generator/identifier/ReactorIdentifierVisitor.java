    ...
    private record IdentifierAppender(IdentifierLocation location, IdentifierOperator operator, String name,
        ...
        private void emitStringOperator(MethodVisitor mv) {
            switch (operator) {
                ...
                case CONTAINS ->
                        mv.visitMethodInsn(INVOKEVIRTUAL, JAVA_LANG_STRING, "contains", "(Ljava/lang/CharSequence;)Z", false);
                case STARTS_WITH ->
                        mv.visitMethodInsn(INVOKEVIRTUAL, JAVA_LANG_STRING, "startsWith", "(Ljava/lang/String;)Z", false);
                case ENDS_WITH ->
                        mv.visitMethodInsn(INVOKEVIRTUAL, JAVA_LANG_STRING, "endsWith", "(Ljava/lang/String;)Z", false);
            }
        }
